...
__커넥션을 맺을 때 사용하는 포트는 시간이 지남에 따라 재사용된다.__ 따라서 두 통신이 과거에 사용된 포트 번호 쌍을 사용할 가능성이 생기고 난수가 아닌 순차적 Number가 전송된다면 이전의 커넥션으로부터 오는 패킷으로 인식할 가능성이 생긴다.__ https://eunhyee.tistory.com/246
